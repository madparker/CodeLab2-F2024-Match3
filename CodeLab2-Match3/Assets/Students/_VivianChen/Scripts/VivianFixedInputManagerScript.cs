...
public class VivianFixedInputManagerScript : MonoBehaviour {

	protected VivianFixedGameManagerScript gameManager;
	protected VivianFixedMoveTokensScript moveManager;
	protected GameObject selected = null;

	//On start, pull two other scripts to be used in this one.
	public virtual void Start () {
		moveManager = GetComponent<VivianFixedMoveTokensScript>();

...
public class VivianFixedGameManagerScript : MonoBehaviour {
	...
	protected VivianFixedInputManagerScript inputManager;
	protected VivianFixedRepopulateScript repopulateManager;
	protected VivianFixedMoveTokensScript moveTokenManager;
	...
	public virtual void Start () {
		...
		inputManager = GetComponent<VivianFixedInputManagerScript>();
		repopulateManager = GetComponent<VivianFixedRepopulateScript>();
		moveTokenManager = GetComponent<VivianFixedMoveTokensScript>();
	}
